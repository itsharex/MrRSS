...
const en: TranslationMessages = {
  ...
  aiApiKey: 'AI API Key',
  aiApiKeyDesc: 'Enter your AI service API key (leave empty if you are using a local model)',
  aiApiKeyPlaceholder: 'Enter your API key',
  aiEndpoint: 'API Endpoint',
  aiEndpointDesc: 'Full API endpoint URL including path. Local endpoints also supported.',
  ...
  summaryAiEndpointPlaceholder: 'https://api.openai.com/v1/chat/completions',
  ...
  aiApiKeyMissing: 'AI API key is missing or invalid. Please configure it in settings.',
  ...
  xpathItemPlaceholder: '//div[contains(@class, "post")]',
  xpathItemHelp: 'XPath expression to select article containers',
  xpathItemTitle: 'Title XPath',
  xpathItemTitlePlaceholder: './/h1[contains(@class, "title")]',
  xpathItemUri: 'URL XPath',
  xpathItemUriPlaceholder: './/a[contains(@class, "link")]/@href',
  xpathItemContent: 'Content XPath',
  xpathItemContentPlaceholder: './/div[contains(@class, "content")]',
  xpathItemAuthor: 'Author XPath',
  xpathItemAuthorPlaceholder: './/span[contains(@class, "author")]',
  xpathItemTimestamp: 'Timestamp XPath',
  xpathItemTimestampPlaceholder: './/time/@datetime',
  xpathItemTimeFormat: 'Time Format',
  xpathItemTimeFormatPlaceholder: '2006-01-02 15:04:05',
  xpathItemThumbnail: 'Thumbnail XPath',
  xpathItemThumbnailPlaceholder: './/img/@src',
  xpathItemCategories: 'Categories XPath',
  xpathItemCategoriesPlaceholder: './/span[contains(@class, "tag")]',
  xpathItemUid: 'UID XPath',
  xpathItemUidPlaceholder: './/article/@id',
